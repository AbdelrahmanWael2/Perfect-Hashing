...
class ON2_DictionaryTest {
    ...
    void batchInsert() throws IOException {
        ...
        assertEquals("8 items added and 9992 not exist",
                d2.batchInsert("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/TestN2.txt"));
        assertEquals("0 items added and 10000 not exist",
                d2.batchInsert("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/TestN2.txt"));
        assertEquals("10000 items added and 0 not exist",
                d2.batchInsert("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/Test2N2.txt"));
    ...
    void batchDelete() throws IOException {
        ...
        assertEquals("10000 items added and 0 not exist",
                d2.batchInsert("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/Test2N2.txt"));
        assertEquals("10000 items deleted 0 items not exist",
                d2.batchDelete("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/Test2N2.txt"));
        assertEquals("0 items deleted 10000 items not exist",
                d2.batchDelete("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/TestN2.txt"));
    ...
    void test2() throws IOException {
        ...
        assertEquals("7 items deleted 9993 items not exist",
                d2.batchDelete("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/TestN2.txt"));
    }
    ...
    void test3() throws IOException {
        ...
        assertEquals("5 items added and 3 not exist",
                d2.batchInsert("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/Test3.txt"));
        ...
        assertEquals("4 items deleted 4 items not exist",
                d2.batchDelete("/home/ahmed/level2term2/Ds2/Perfect-Hashing/src/Test3.txt"));
    }
