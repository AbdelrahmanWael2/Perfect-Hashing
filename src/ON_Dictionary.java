...
public class ON_Dictionary implements Dictionary{
    ...
    public String search(String searchString) {
        if(On_dictionary.search(searchString)) return searchString + " was found";
        else return searchString + " was not found";
    }

    @Override
    public String delete(String deleteString) {
        if(On_dictionary.delete(deleteString)) return deleteString + " was found and deleted";
