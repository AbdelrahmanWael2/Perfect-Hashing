...
//    the tests affect each other
    ...
    void batchInsert() throws IOException {
        ...
        assertEquals("8 items added and 999992 not exist",d1.batchInsert("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test.txt"));
        assertEquals("0 items added and 1000000 not exist",d1.batchInsert("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test.txt"));
        assertEquals("1000000 items added and 0 not exist",d1.batchInsert("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test2.txt"));
    ...
    void batchDelete() throws IOException {
        ON_Dictionary d1 = new ON_Dictionary(1000000);
        assertEquals("1000000 items added and 0 not exist",d1.batchInsert("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test2.txt"));
        assertEquals("1000000 items deleted 0 items not exist",d1.batchDelete("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test2.txt"));
        assertEquals("0 items deleted 1000000 items not exist",d1.batchDelete("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test.txt"));
    ...
    void test2() throws IOException {
        ...
        assertEquals("7 items deleted 999993 items not exist",d1.batchDelete("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test.txt"));
    }
//    small files to batch insert and delete from it then batch delete it
    @org.junit.jupiter.api.Test
    void test3() throws IOException {
        ON_Dictionary d1 = new ON_Dictionary(6);
        assertEquals("5 items added and 3 not exist",d1.batchInsert("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test3.txt"));
//        deleted element from the 5 then we batch delete the file we will see that 4 items is deleted only not file
        ...
        assertEquals("4 items deleted 4 items not exist",d1.batchDelete("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test3.txt"));
    }
...
//    that is not true because there is no item in the file is deleted
    ...
    void test5() throws IOException {
        ...
        assertEquals("1 items deleted 7 items not exist",d1.batchDelete("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test3.txt"));
        assertEquals("magdy not found", d1.search("magdy"));
        assertEquals("Ali inserted successfully",d1.insert("Ali"));
        assertEquals("0 items deleted 8 items not exist",d1.batchDelete("D:\\CSED2_2\\DS\\labs\\hashing\\Perfect-Hashing\\src\\Test3.txt"));
